        ...
        http
                ...
                .authorizeRequests(authorize -> authorize
                        .antMatchers("/images/**", "/api/boardList", "/api/sign-in", "/api/register", "/api/prove", "/swagger-ui.html", "/api/profile", "/api/boardList","/api/boardGet"
                        		, "/api/boardAnswer", "/api/application","/api/getMonthAds","/api/getChartAd","/api/getBarChartAd","/api/getUserAds",
                        		"/api/Refuse","/api/Approval","/api/GetVideoUrl","/api/SelectVd").permitAll()
